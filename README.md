...
Agent skills for [Orshot](https://orshot.com) – the automated visual content generation platform for images, PDFs, and videos.
...
Comprehensive skill for integrating with the Orshot API. Covers image/PDF/video generation from templates, dynamic parameters, style overrides, AI content generation, SDKs (Node.js, Python, PHP, Ruby), and all integrations.
